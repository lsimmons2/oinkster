...
describe('POST /users', function() {
  ...
  describe('should return 200 and a token if user doesn\'t exist', function(){
    ...
    before( function(done) {
      umzug.execute({
        migrations: ['drop-all-tables', 'create-users-table'],
        method: 'up'
      })
      .then(function(migrations) {
        console.log('Migrations complete: drop-all-tables, create-users-table');
        done();
      });
    })
    ...
    // after( function(done) {
    //   umzug.execute({
    //     migrations: ['drop-users-table'],
    //     method: 'up'
    //   })
    //   .then(function()  {
    //     console.log('Migrations complete: drop-users-table');
    //     done();
    //   });
    // })
